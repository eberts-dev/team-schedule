...
### Вариант 1 (Минимальные требования)

- Отображение запланированных смен
...
### Вариант 2 (Обычная сложность)

- Отображение запланированны и фактических смен
- Легенда для опозданий, ранних уходов и отсутствий
- Без ограничений по диапазону дат
- Цветовая индикация статуса
- Блокировка скролла на мобильных устройстваx
